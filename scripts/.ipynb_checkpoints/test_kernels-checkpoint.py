...
k1 = k_lin_t * k_se_agesex
k2 = k_lin_t * k_se_tagesex
k3 = k_se_agesex + k_lin_cohort * k_se_cohort
k4 = k_lin_t * k_se_tagesex + k_se_cohort
k5 = k_lin_t * k_se_tagesex + k_lin_ugap * k_se_agesex
k6 = k_lin_t * k_se_tagesex + k_lin_ugap * k_se_agesex + k_lin_ugapl1 * k_se_agesex + k_lin_ugapl2 * k_se_agesex
k7 = k_lin_cohort * k_se_cohort * k_se_agesex
