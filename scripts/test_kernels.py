...
k2 = k_se_tagesex + k_lin_t * k_se_tagesex
k3 = k_se_agesex * k_se_cohort + k_lin_cohort * k_se_cohort * k_se_agesex
k4 = k_se_tagesex + k_lin_t * k_se_tagesex + k_se_cohort
k5 = k_se_agesex + k_lin_cohort * k_se_cohort
k6 = k_se_tagesex + k_lin_t * k_se_tagesex + k_lin_ugap * k_se_agesex
k7 = k_se_tagesex + k_lin_t * k_se_tagesex + k_lin_ugap * k_se_agesex + k_lin_ugapl1 * k_se_agesex + k_lin_ugapl2 * k_se_agesex
...
with open('output/pkl/test_kernels.pkl', 'wb') as f:
    pickle.dump(ms, f)
